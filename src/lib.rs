...
pub use extract::{
    ...
    apply_staged_fixes_preview, compare_diff_algorithms, compute_line_diff,
    compute_line_diff_hirschberg, compute_line_diff_lcs, compute_line_diff_myers,
    compute_line_diff_unified, compute_line_diff_with_algorithm, detect_missing_result_returns,
    ensure_anyhow_import, ensure_anyhow_imports, ensure_anyhow_imports_extended,
    ensure_external_imports, ensure_std_imports, extract_files, extract_glob_imports,
    format_diff_comparison, format_diff_summary, format_diff_unified, format_diff_unified_colored,
    ...
    IdempotencyResult, ImportIssue, ImportReport, IssueType, LineDiff, LineDiffType, QualityIssue,
    StagedFixPreview,
};
