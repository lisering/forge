...
pub use extract::{
    ...
    detect_truncated_files, ensure_anyhow_import, ensure_anyhow_imports,
    ensure_anyhow_imports_extended, ensure_external_imports, ensure_std_imports, extract_files,
    extract_glob_imports, format_diff_comparison, format_diff_summary, format_diff_unified,
    ...
    ImportReport, IssueType, LineDiff, LineDiffType, QualityIssue, StagedFixPreview,
};
