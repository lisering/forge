...
pub use extract::{
    ...
    apply_staged_fixes_preview, apply_staged_fixes_with_validation, compare_diff_algorithms,
    compute_line_diff, compute_line_diff_hirschberg, compute_line_diff_lcs,
    compute_line_diff_myers, compute_line_diff_unified, compute_line_diff_with_algorithm,
    detect_missing_result_returns, detect_truncated_files, ensure_anyhow_import,
